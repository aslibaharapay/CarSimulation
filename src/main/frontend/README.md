...
The default Jest coverage configuration can be overriden by adding any of the following supported keys to a Jest com.mercedes.vehicle.api.car.simulator.config in your package.json.
...
[`webpack.com.mercedes.vehicle.api.car.simulator.config.prod.js`](../config/webpack.config.prod.js).
